...
while game == True:
    while prompt3[0:4].lower != "exit" or prompt2[0:4].lower == "stop" or prompt1[0:4].lower() == "what":
        ...
        if(prompt1[0:6].lower() == "change"):
                ...
                while prompt3[0:3].lower != "exit" or prompt3[0:3].lower == "stop" or prompt3[0:2].lower != "run" or prompt3[0:5].lower != "attack" or prompt3[0:6].lower != "defend" or prompt3[0:4].lower != "tame":
                    ...
                    if prompt3[0:3].lower == "run":
                        ...
                        if Cheese == True:
                            ...
                            Amity += 1
                            print("You lay on the ground and face the dog./n The dog backs off because you are showing submission to it.")
                        ...
                        Erudite += 1
                        Amity += 1
                        print("You kick over one of the tables, and use it as a sheild from the dog.")
            ...
            print("You are now on a bus, no one is on it exept for you and one other person. The other person is reading a newspaper, the cover of the newspaper has a person on it that you seem to remember, but you don't exactly know their name.")
