...
do
    ...
    while ((name === "") || (name === "/dev") || (name === "/DEV") || (name === "/Dev") || (name === "Developer Mode") || (name === "No") || (name === "no") || (name === "NO") || (name === "NO!") || (name === "Not happening") || (name === "Get away from me") || (name === "Minecraft"))
...
//I hope you change your clothes...
        {
        Clothes = Faction;
        alert("You changed into your birth faction clothes, you are now ready to go to school.");
        }
...
// This determines if you are Divergent, a very basic true or false, depending on what you chose in the cheese or knife. If you were divergent, you would have chosen 'no'                    
            if (Divergent === true)
                ...
                alert("'I should not tell you any more, now go.'");
                alert("That is the end of the Divergent Aptitude Test!");
