...
// Ask what they want to do    
    ...
    if (prompt1 === "Look in your drawer") 
        {
        alert("You find a few books that you were missing for a while. So that is where they were...");
        books = true;
        Eridite = Eridite + 1;
        }
    if (prompt1 === "Quit")
...
// If they did not previously choose the Knife or Cheese                            
            ...
            if (prompt3 ===  "Run") 
                {
                alert("You lunge at one of the doors, expecting it to open. It is locked. You must come up with another idea.");
                }
            if (prompt3 === "Tame") 
                {
                if (Cheese === true) 
                    {
                    Amity = Amity + 1;
                    alert("The dog is going crazy for the wedge of cheese in your hand. You throw him some, and he immediately calms down. A little girls runs up to you, thanks you for finding her dog, and runs away. You decide to take bus back to your home.");
                    }
                }
            ...
            if (prompt3 === "Defend") 
                ...
                alert("The dog looks at you and licks your ear. A little girl walks over and pets the dog. 'Thanks for finding my dog for me! I have to go now, but I hope to see you soon!' she says, then runs away. You decide to take bus back to your home.");
                }
            if (prompt3 === "Quit") 
                {
                game = false;
